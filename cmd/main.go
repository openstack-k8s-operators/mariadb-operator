...
// Package main is the entry point for the mariadb-operator.
package main
...
import (
	...
	"github.com/openstack-k8s-operators/mariadb-operator/internal/controller"
	webhookv1beta1 "github.com/openstack-k8s-operators/mariadb-operator/internal/webhook/v1beta1"
...
func main() {
	...
	if err := (&controller.GaleraReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	}).SetupWithManager(mgr); err != nil {
	...
	if err := (&controller.MariaDBAccountReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	}).SetupWithManager(mgr); err != nil {
	...
	if err := (&controller.GaleraBackupReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	}).SetupWithManager(mgr); err != nil {
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1beta1.SetupGaleraWebhookWithManager(mgr); err != nil {
