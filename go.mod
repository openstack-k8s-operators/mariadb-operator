...
replace github.com/openstack-k8s-operators/lib-common/modules/common => github.com/zzzeek/lib-common/modules/common v0.0.0-20260519194359-f7a36c578816 //allow-merging
