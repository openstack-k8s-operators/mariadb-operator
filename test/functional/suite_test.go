...
import (
	...
	mariadb_ctrl "github.com/openstack-k8s-operators/mariadb-operator/internal/controller"
	webhookv1 "github.com/openstack-k8s-operators/mariadb-operator/internal/webhook/v1beta1"
...
var _ = BeforeSuite(func() {
	...
	err = webhookv1.SetupGaleraWebhookWithManager(k8sManager)
	Expect(err).NotTo(HaveOccurred())
