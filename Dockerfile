...
ARG REMOTE_SOURCE=.
ARG REMOTE_SOURCE_DIR=mariadb-operator
...
RUN cp config/crd/bases/database.openstack.org_mariadbs.yaml ${DEST_ROOT}/bundle/database.openstack.org_mariadbs_crd.yaml
RUN cp config/crd/bases/database.openstack.org_mariadbdatabases.yaml ${DEST_ROOT}/bundle/database.openstack.org_mariadbdatabases_crd.yaml
