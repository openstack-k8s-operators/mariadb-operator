...
// DeleteAccountFinalizers removes the finalizer from a MariaDBAccount and its
// associated Secret, if they exist. This function is also invoked by
// DeleteDatabaseAndAccountFinalizers to handle the account portion of the cleanup.
func DeleteAccountFinalizers(
	...
	if namespace == "" {
		return fmt.Errorf("namespace is blank")
	}
